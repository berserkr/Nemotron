...
#SBATCH --nodes=32
#SBATCH --job-name=granite-8b-sft-256k-32n
...
# 32 nodes x 4 GPUs = 128 GPUs: TP=2, CP=4, DP=16
CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_HOME=/usr/local/cuda-12 torchrun ${DISTRIBUTED_ARGS} src/nemotron/recipes/super3/stage1_sft/train.py --config src/nemotron/recipes/granite30/stage1_sft/config/train_granite_8b_256k_32n.yaml"
