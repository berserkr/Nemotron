...
#SBATCH --nodes=2
#SBATCH --job-name=granite-3b-sft-256k
...
# 2 nodes x 4 GPUs = 8 GPUs: TP=1, CP=2, DP=4
CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_HOME=/usr/local/cuda-12 torchrun ${DISTRIBUTED_ARGS} src/nemotron/recipes/super3/stage1_sft/train.py --config src/nemotron/recipes/granite30/stage1_sft/config/train_granite_3b_256k_2n.yaml"
