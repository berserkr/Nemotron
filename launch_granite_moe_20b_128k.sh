...
#SBATCH --nodes=16
#SBATCH --job-name=granite-moe20b-sft-128k
...
# 16 nodes x 4 GPUs = 64 GPUs: TP=2, EP=8, CP=4, DP=1
CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_HOME=/usr/local/cuda-12 torchrun ${DISTRIBUTED_ARGS} src/nemotron/recipes/super3/stage1_sft/train.py --config src/nemotron/recipes/granite30/stage1_sft/config/train_granite_moe_20b_128k.yaml"
