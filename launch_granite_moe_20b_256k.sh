...
#SBATCH --nodes=32
#SBATCH --job-name=granite-moe20b-sft-256k
...
# 32 nodes x 4 GPUs = 128 GPUs: TP=2, EP=8, CP=8, DP=1
CMD="CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_HOME=/usr/local/cuda-12 torchrun ${DISTRIBUTED_ARGS} src/nemotron/recipes/super3/stage1_sft/train.py --config src/nemotron/recipes/granite30/stage1_sft/config/train_granite_moe_20b_256k.yaml"
